$(document).ready(function() {
	...
	function taskList() {
	    ...
	    $.ajax({
	        url: 'http://34.221.226.203:32108/todolist/Tasks/Task/',
	        type: 'GET',
	        dataType: 'json',
	...
	function taskUpdate(task) {
	    $.ajax({
	        url: "http://34.221.226.203:32108/todolist/Tasks/Task/" + task.id,
	        type: 'PUT',
	...
	function taskGet(ctl) {
	    ...
	    $.ajax({
	        url: "http://34.221.226.203:32108/todolist/Tasks/Task/" + id,
	        type: 'GET',
	        dataType: 'json',
	        success: function(task) {
	            taskToFields(task);
